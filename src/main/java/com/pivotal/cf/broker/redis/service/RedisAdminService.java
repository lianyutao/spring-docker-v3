...
public class RedisAdminService {
	...
	private Logger logger = LoggerFactory.getLogger(RedisAdminService.class);
...
//		String createParams = "{\"image\":\"redis-2.8.4\"}";
...
//        json = (DockerTemplate) JsonUtil.toObject(obj.toString(), DockerTemplate.class, classMap);
		...
		showResult.put("containerPasswd", getDockerBaseEntryValue(envList, "REDIS_PASS"));
