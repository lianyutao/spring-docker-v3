...
//		String createParams = "{\"image\":\"postgresql-9.4.1\"}";
		DockerTemplate temp=new DockerTemplate();
		temp.setImage("postgresql");
...
//        json = (DockerTemplate) JsonUtil.toObject(obj.toString(), DockerTemplate.class, classMap);
		...
		showResult.put("containerUser", getDockerBaseEntryValue(envList, "DEFAULT_USER"));
		showResult.put("containerPasswd", getDockerBaseEntryValue(envList, "DEFAULT_PASS"));
		showResult.put("containerDb", "postgres");		
