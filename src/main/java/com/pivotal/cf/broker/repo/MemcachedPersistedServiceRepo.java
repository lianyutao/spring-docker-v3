...
@Component
public class MemcachedPersistedServiceRepo implements ServiceRepo {
	private Logger logger = LoggerFactory.getLogger(MemcachedPersistedServiceRepo.class);
    ...
    private static final String addInstanceSQL = "INSERT INTO memcacheddockerserviceinstance " +
            "(SERVICE_INSTANCE_ID, SERVICE_ID, PLAN_ID, ORGANIZATION_GUID, SPACE_GUID, DASHBOARD_URL, "
            + "CONTAINER_ID, CONTAINER_HOST, CONTAINER_PORT, CONTAINER_USER, CONTAINER_PASSWD) " +
            "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    private static final String removeInstanceSQL = "DELETE FROM memcacheddockerserviceinstance " +
            "WHERE SERVICE_INSTANCE_ID = ?";
    private static final String getInstanceSQL = "SELECT * FROM memcacheddockerserviceinstance " +
            "WHERE SERVICE_INSTANCE_ID = ?";
    private static final String getInstancesSQL = "SELECT * FROM memcacheddockerserviceinstance";
    private static final String updateInstancesSQL = "update memcacheddockerserviceinstance set PLAN_ID=?, CONTAINER_ID=? "
    		+ "where SERVICE_INSTANCE_ID=?";
    //ccdb
