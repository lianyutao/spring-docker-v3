...
@Component
public class PostgresqlPersistedServiceRepo implements ServiceRepo {
	private Logger logger = LoggerFactory.getLogger(PostgresqlPersistedServiceRepo.class);
    ...
    private static final String addInstanceSQL = "INSERT INTO postgresqldockerserviceinstance " +
            "(SERVICE_INSTANCE_ID, SERVICE_ID, PLAN_ID, ORGANIZATION_GUID, SPACE_GUID, DASHBOARD_URL, "
            + "CONTAINER_ID, CONTAINER_HOST, CONTAINER_PORT, CONTAINER_USER, CONTAINER_PASSWD, CONTAINER_DB) " +
            "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    private static final String removeInstanceSQL = "DELETE FROM postgresqldockerserviceinstance " +
            "WHERE SERVICE_INSTANCE_ID = ?";
    private static final String getInstanceSQL = "SELECT * FROM postgresqldockerserviceinstance " +
            "WHERE SERVICE_INSTANCE_ID = ?";
    private static final String getInstancesSQL = "SELECT * FROM postgresqldockerserviceinstance";
    private static final String updateInstancesSQL = "update postgresqldockerserviceinstance set PLAN_ID=?, CONTAINER_ID=? "
    		+ "where SERVICE_INSTANCE_ID=?";
    //ccdb
    ...
    private static final String addNewRecord = "insert into t_meterage (org_guid, org_name, space_guid, space_name, "
    		+ "reource_type, resource_guid, memory, cpu, disk,  traffic, "
    ...
    private class ServiceInstanceRowMapper implements RowMapper<ServiceInstance> {
        ...
        public ServiceInstance mapRow(ResultSet rs, int rowNum) throws SQLException {
            return new ServiceInstance(
                    ...
                    rs.getString("CONTAINER_USER"),
                    rs.getString("CONTAINER_PASSWD"),
                    rs.getString("CONTAINER_DB")
                    );
        }
    }
