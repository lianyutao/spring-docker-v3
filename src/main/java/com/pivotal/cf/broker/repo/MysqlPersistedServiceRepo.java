...
@Component
public class MysqlPersistedServiceRepo implements ServiceRepo {
	private Logger logger = LoggerFactory.getLogger(MysqlPersistedServiceRepo.class);
    ...
    private static final String addInstanceSQL = "INSERT INTO mysqldockerserviceinstance " +
            ...
            "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    private static final String removeInstanceSQL = "DELETE FROM mysqldockerserviceinstance " +
            "WHERE SERVICE_INSTANCE_ID = ?";
    private static final String getInstanceSQL = "SELECT * FROM mysqldockerserviceinstance " +
            "WHERE SERVICE_INSTANCE_ID = ?";
    private static final String getInstancesSQL = "SELECT * FROM mysqldockerserviceinstance";
    private static final String updateInstancesSQL = "update mysqldockerserviceinstance set PLAN_ID=?, CONTAINER_ID=? "
    		+ "where SERVICE_INSTANCE_ID=?";
