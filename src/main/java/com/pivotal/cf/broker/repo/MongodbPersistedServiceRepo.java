...
@Component
public class MongodbPersistedServiceRepo implements ServiceRepo {
	private Logger logger = LoggerFactory.getLogger(MongodbPersistedServiceRepo.class);
    ...
    private static final String addInstanceSQL = "INSERT INTO mongodbdockerserviceinstance " +
            ...
            "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    private static final String removeInstanceSQL = "DELETE FROM mongodbdockerserviceinstance " +
            "WHERE SERVICE_INSTANCE_ID = ?";
    private static final String getInstanceSQL = "SELECT * FROM mongodbdockerserviceinstance " +
            "WHERE SERVICE_INSTANCE_ID = ?";
    private static final String getInstancesSQL = "SELECT * FROM mongodbdockerserviceinstance";
    private static final String updateInstancesSQL = "update mongodbdockerserviceinstance set PLAN_ID=?, CONTAINER_ID=? "
    		+ "where SERVICE_INSTANCE_ID=?";
    //ccdb
